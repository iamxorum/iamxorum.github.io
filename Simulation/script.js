(async () => {
  try {
    ...
    function startRandomQuestions() {
      ...
      allQuestionsArray = json1.slice(0, 3).concat(json2.slice(0, 3), json3.slice(0, 3), json4.slice(0, 3), json5.slice(0, 3), json6.slice(0, 3), json7.slice(0, 3), json8.slice(0, 3), json9.slice(0, 3), json10.slice(0, 3), json11.slice(0, 3), json12.slice(0, 3), json13.slice(0, 3));
